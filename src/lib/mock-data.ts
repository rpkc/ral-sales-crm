...
export const mockLeads: Lead[] = [
  ...
  },
  {
    ...
    interestedCourse: "Digital Marketing", assignedTelecallerId: "u4", status: "Follow-up", createdAt: "2026-03-22",
    leadScore: 60, leadQuality: "Warm", budgetRange: "₹90k", urgencyLevel: "Low", otherInstitutes: "ISB, IIM",
  ...
  },
  {
    ...
    priorityScore: 50, priorityCategory: "Medium Priority",
    activities: [
  ...
  },
  {
    ...
    interestedCourse: "Graphic Design", assignedTelecallerId: "u3", status: "Qualified", createdAt: "2026-03-18",
    leadScore: 78, leadQuality: "Hot", budgetRange: "₹45k", urgencyLevel: "High",
    ...
    qualificationScore: 100,
    activities: [
      { id: "a26", leadId: "l13", type: "Lead Created", description: "Instagram DM inquiry", timestamp: "2026-03-18T11:00:00" },
      { id: "a27", leadId: "l13", type: "Call Connected", description: "Very keen, portfolio-ready", channel: "Phone Call", userId: "u3", timestamp: "2026-03-18T15:00:00" },
    ],
  },
  {
  ...
  },
  {
    ...
    interestedCourse: "Full Stack Development", assignedTelecallerId: "u4", status: "Qualified", createdAt: "2026-03-17",
    leadScore: 80, leadQuality: "Hot", budgetRange: "₹4.1L", urgencyLevel: "High",
    ...
    qualificationScore: 100, admissionProbability: "High",
    activities: [
      { id: "a35", leadId: "l18", type: "Lead Created", description: "Education Fair signup", timestamp: "2026-03-17T10:00:00" },
      { id: "a36", leadId: "l18", type: "Call Connected", description: "Very keen, wants to start next batch", channel: "Phone Call", userId: "u4", timestamp: "2026-03-17T14:00:00" },
    ],
  },
  {
    ...
    highestQualification: "MBA", currentStatus: "Working Professional", careerGoal: "Digital Marketer",
  ...
  },
  {
    ...
    interestedCourse: "HTML & CSS", assignedTelecallerId: "u3", status: "New", createdAt: "2026-03-25",
    leadScore: 40, leadQuality: "Cold", budgetRange: "₹15k", urgencyLevel: "Low",
    highestQualification: "Class 12", currentStatus: "Student", careerGoal: "Web Developer", preferredStartTime: "Within 3 Months",
    leadSourceFormType: "Walk-in", leadMotivation: "Skill Upgrade",
    intentScore: 35, intentCategory: "Low Intent", temperature: "Cold", priorityScore: 40, priorityCategory: "Low Priority",
    activities: [{ id: "a41", leadId: "l22", type: "Lead Created", description: "Walk-in inquiry — basic web course", timestamp: "2026-03-25T11:00:00" }],
  },
  {
    id: "l23", name: "Shreya Mitra", phone: "9876543232", email: "shreya.m@email.com", source: "Alumni Referral", campaignId: "c1",
    interestedCourse: "Motion Graphics", assignedTelecallerId: "u4", status: "Follow-up", createdAt: "2026-03-20",
    leadScore: 68, leadQuality: "Warm", budgetRange: "₹1.18L", urgencyLevel: "Medium",
    highestQualification: "B.A", currentStatus: "Fresher", careerGoal: "Animator", preferredStartTime: "Within 1 Month",
    leadSourceFormType: "Free Callback", leadMotivation: "Portfolio Building",
    intentScore: 65, intentCategory: "Medium Intent", temperature: "Warm", priorityScore: 68, priorityCategory: "Medium Priority",
    assignedCounselor: "u5",
    activities: [
      { id: "a42", leadId: "l23", type: "Lead Created", description: "Alumni referral", timestamp: "2026-03-20T08:00:00" },
      { id: "a43", leadId: "l23", type: "Call Connected", description: "Wants to attend demo class", channel: "Phone Call", userId: "u4", timestamp: "2026-03-20T12:00:00" },
    ],
  },
  {
  ...
  },
  {
    ...
    interestedCourse: "Graphic Design", assignedTelecallerId: "u4", status: "Counseling", createdAt: "2026-03-18",
    leadScore: 76, leadQuality: "Warm", budgetRange: "₹45k", urgencyLevel: "Medium",
    highestQualification: "Diploma", currentStatus: "Fresher", careerGoal: "Graphic Designer", preferredStartTime: "Immediate",
    leadSourceFormType: "Free Counselling", leadMotivation: "Job Placement",
